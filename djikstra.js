...
function findPath(){
    ...
    document.getElementById("fromNode").innerHTML=fromNode;
    document.getElementById("toNode").innerHTML=toNode;
    document.getElementById("shortestpath").innerHTML=shortestPath;
}